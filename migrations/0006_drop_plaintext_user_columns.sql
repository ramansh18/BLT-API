-- Migration number: 0006   2026-03-20T00:00:00.000Z

-- Drop plaintext-sensitive user fields by rebuilding the users table.
-- This migration requires encrypted fields from migration 0005 to be populated.
...
-- This INSERT will fail (and abort migration) if encrypted data is missing,
